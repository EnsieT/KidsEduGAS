...
export default function MathActivity({ language, onComplete, onBack }: ActivityProps) {
  ...
  return (
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 flex flex-col items-center justify-center gap-16">
        <div className="flex items-center gap-8 text-8xl font-black text-indigo-800 bg-white px-12 py-8 rounded-3xl shadow-xl border-4 border-indigo-100">
        ...
        <div className="flex gap-8">
          {options.map((opt, i) => (
            <motion.button
              ...
              className="w-32 h-32 bg-gradient-to-br from-indigo-500 to-purple-600 text-white rounded-2xl shadow-lg border-4 border-indigo-200 flex items-center justify-center text-6xl font-bold hover:shadow-2xl transition-all"
            >
              {opt}
            </motion.button>
          ))}
